...
class CreateRequestKeyValue implements ModelInterface, ArrayAccess {
   ...
   *   Field names of the source content for translation.
   *
   * @return $this
   */
   ...
   *   Field values of the source content for translation. The order of fields should match that of the fieldNames parameter.
   *
   * @return $this
   */
