...
/**
 * Adds the category id to the indexed data.
 *
 * @SearchApiProcessor(
 *   id = "field_category",
 *   label = @Translation("Category id"),
 *   description = @Translation("Adds the category id of page to the indexed data."),
 *   stages = {
 *     "add_properties" = 0,
 *   },
 *   locked = true,
 ...
 * )
 */
class CategoryId extends ProcessorPluginBase {
   ...
   * @var string
   */
  protected $processor_id = 'field_category'; // phpcs:ignore
  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL) {
    ...
    if (!$datasource) {
      $definition = [
        ...
        'description' => $this->t('Category id'),
        'type' => 'string',
