...
/**
 * Adds the product tag name to the indexed data.
 *
 * @SearchApiProcessor(
 *   id = "product_tag",
 *   label = @Translation("Product tag name"),
 *   description = @Translation("Adds the Product tag name of page to the indexed data."),
 *   stages = {
 *     "add_properties" = 0,
 *   },
 *   locked = true,
 ...
 * )
 */
class ProductTagName extends ProcessorPluginBase {
   ...
   * @var string
   */
  protected $processor_id = 'product_tag'; // phpcs:ignore
  ...
  public function getPropertyDefinitions(DatasourceInterface $datasource = NULL) {
    ...
    if (!$datasource) {
      $definition = [
        'label' => $this->t('Product tag name'),
        'description' => $this->t('Product tag name'),
        'type' => 'string',
