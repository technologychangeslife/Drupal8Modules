...
namespace Drupal\bh_share_price\Extension;

/**
 * Class SharePriceInfoExtension.
 *
 * @package Drupal\bh_share_price\Extension
 */
class SharePriceInfoExtension extends \Twig_Extension {
  ...
  public function getName() {
    return 'bh_share_price_extension';
  }
  ...
  public function getFeed() {
    $share_price_info = \Drupal::service('bh_share_price.share_price_info.class');
